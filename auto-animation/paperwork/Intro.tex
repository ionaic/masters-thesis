...
\begin{figure}[htp]
    \centering
    \includegraphics{images/spritesheet.png}
    \caption[Example of a 2D spritesheet]{This example shows a 2D spritesheet used to produce a jumping animation for a stick figure character.  The frames in this case are laid out in a single image for demonstration purposes, progressing in order starting with frame 0.
