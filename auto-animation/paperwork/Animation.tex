...
\section{In Air Maneuvers and landing}
While in the air, the character is limited in its maneuvers.  Small adjustments can be made, mainly preparations for landing.  As discussed in \cite{falling_landing}, a portion of the body may be raised or lowered if another portion is lowered or raised respectively.  This allows the character to control angular velocity with adjustments to pose.
