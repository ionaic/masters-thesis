\begin{table}[ht]
	...
	\begin{tabular}{|p{0.1\textwidth}|p{0.9\textwidth}|}
		...
		0.75m box &%
			...
			\\ \hline
	\end{tabular}
	\caption[Table of frame sequences for forward and box jumps, $k=20000$ global]{Table of forward jumping motions}
...
\begin{table}[ht]
	...
	\begin{tabular}{|p{0.1\textwidth}|p{0.9\textwidth}|}
		...
		1.6m right &%
			...
			\\ \hline
	\end{tabular}
	\caption[Table of frame sequences for sideways jumps, $k=20000$ global]{Table of rightward jumping motions.}
...
\begin{table}[ht]
	...
	\begin{tabular}{|p{0.1\textwidth}|p{0.9\textwidth}|}
		...
		0.75m box &%
			...
			\\ \hline
	\end{tabular}
	\caption[Table of frame sequences for forward and box jumps, $k=20000$ varying]{Table of forward jumping motions}
...
\begin{table}[ht]
	...
	\begin{tabular}{|p{0.1\textwidth}|p{0.9\textwidth}|}
		...
		1.9m forward (varying $k=20000$) &%
			...
			\\ \hline
	\end{tabular}
	\caption[Table of frame sequences for jumps with uneven leg strengths, $k=20000$ global]{Table of forward jumping motions}
