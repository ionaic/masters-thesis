\begin{table}[ht]
	...
	\begin{tabular}{|c|p{0.9\textwidth}|}
		...
		0.75m box &%
			...
			\\ \hline
	\end{tabular}
	\caption[Table of frame sequences for forward jumps, $k=200000$ global]{Table of forward jumping motions}
\end{table}
...
\begin{table}[ht]
	...
	\begin{tabular}{|c|p{0.9\textwidth}|}
		...
		1.6m right &%
			...
			\\ \hline
	\end{tabular}
	\caption[Table of frame sequences for forward jumps, $k=200000$ global]{Table of rightward jumping motions.}
\end{table}
