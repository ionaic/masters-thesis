...
\begin{figure}[ht]
	...
	\begin{tabular}{|p{0.1\textwidth}|p{0.9\textwidth}|}
		...
		1.6m right &%
			...
			\\ \hline
	\end{tabular}
	\caption[Frame sequences for sideways jumps, $k=20000$ global]{Right jump motions for a character with global $k=20000$, $t_{windup}=0.2s$, and $t_{air} = 0.5s$.  The target was placed at the distance listed in the figure in the direction $(1, 0, 0)$ relative to the character.}
    \label{fig:side_200k_g}
\end{figure}
...
\begin{figure}[ht]
	...
	\begin{tabular}{|p{0.1\textwidth}|p{0.9\textwidth}|}
		...
		1.9m forward (varying $k=20000$) &%
			...
			\\ \hline
	\end{tabular}
	\caption[Frame sequences for jumps with uneven leg strengths, $k=20000$ global]{Forward jumping motions with uneven muscle strengths between legs, using $t_{windup}=0.2s$ and $t_{air}=0.5s$.}
    \label{fig:forward_200k_u}
\end{figure}
...
\begin{figure}[ht]
	...
	\begin{tabular}{|p{0.1\textwidth}|p{0.9\textwidth}|}
		...
		1m forward &%
			...
			\\ \hline%
		10m forward &%
			\floatedfigsz{images/trials/k1e10global/10m/1s1point5s/frame0042.png}{0.2}
			\floatedfigsz{images/trials/k1e10global/10m/1s1point5s/frame0047.png}{0.2}
			\floatedfigsz{images/trials/k1e10global/10m/1s1point5s/frame0050.png}{0.2}
			\floatedfigsz{images/trials/k1e10global/10m/1s1point5s/frame0053.png}{0.2}
			\floatedfigsz{images/trials/k1e10global/10m/1s1point5s/frame0055.png}{0.2}
			\floatedfigsz{images/trials/k1e10global/10m/1s1point5s/frame0060.png}{0.2}
			\floatedfigsz{images/trials/k1e10global/10m/1s1point5s/frame0064.png}{0.2}
			\floatedfigsz{images/trials/k1e10global/10m/1s1point5s/frame0066.png}{0.2}
			\floatedfigsz{images/trials/k1e10global/10m/1s1point5s/frame0070.png}{0.2}
			\floatedfigsz{images/trials/k1e10global/10m/1s1point5s/frame0075.png}{0.2}
			\floatedfigsz{images/trials/k1e10global/10m/1s1point5s/frame0080.png}{0.2}
			\floatedfigsz{images/trials/k1e10global/10m/1s1point5s/frame0085.png}{0.2}
			\floatedfigsz{images/trials/k1e10global/10m/1s1point5s/frame0090.png}{0.2}
			\floatedfigsz{images/trials/k1e10global/10m/1s1point5s/frame0095.png}{0.2}
			\floatedfigsz{images/trials/k1e10global/10m/1s1point5s/frame0101.png}{0.2}
			\\ \hline%
	\end{tabular}
	\caption[Frame sequences for forward jumps, $k=1 \times 10^{10}$ global]{Generated frame sequences for the super human trial, where the $k$ values were chosen such that the character could leap over a tall building, a 100m tall box.  Animations above were generated for 1m, 10m, and 100m forward jumps.  The 100m forward jump is not pictured due to the difficulty of capture, as either the jump was out of the range of the camera or the camera was too far to clearly see the animation.}
	\label{fig:superman_forward}
\end{figure}

\begin{figure}[ht]
	\label{fig:superman_box}
	\centering
	\begin{tabular}{|p{0.1\textwidth}|p{0.9\textwidth}|}
		\hline\vspace{1mm}
		1m box &%
		...
		100m box &%
			...
			\\ \hline
	\end{tabular}
	\caption[Frame sequences for box jumps, $k=1 \times 10^{10}$ global]{Animations of 1m and 100m box jumps for the super human.  This trial uses $t_{windup} = 1s$ and $t_{air} = 5s$.}
\end{figure}